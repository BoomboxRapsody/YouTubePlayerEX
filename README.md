...
[![Crowdin](https://badges.crowdin.net/youtube-player-ex/localized.svg)](https://crowdin.com)
...
| [Windows 7+ (x64)](https://github.com/BoomboxRapsody/YouTubePlayerEX/releases/latest/download/YouTubePlayerEX-win-Setup.exe) |
|--------------------------------------------------------------------------------------|
