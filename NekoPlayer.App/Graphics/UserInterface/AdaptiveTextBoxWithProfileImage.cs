...
{
    public partial class AdaptiveTextBoxWithProfileImage : BasicTextBox
    {
        /// <summary>
        ...
        protected override float LeftRightPadding => 45;
        ...
        public AdaptiveTextBoxWithProfileImage()
        {
            Height = 40;
            ...
            Add(profileImage = new ProfileImage(30)
            {
                Enabled = { Value = false },
        ...
        public void RefreshChannelProfile(Channel channel)
        {
            Task.Run(async () =>
            {
