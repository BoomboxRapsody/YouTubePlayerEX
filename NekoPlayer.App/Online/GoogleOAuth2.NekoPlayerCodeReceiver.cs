...
namespace NekoPlayer.App.Online
{
    public partial class GoogleOAuth2
    {
        ...
        /// </summary>
        public partial class NekoPlayerCodeReceiver : ICodeReceiver
        {
            /// <summary>
  ...
  <body>
	<script>
	    window.location.href = ""https://boomboxrapsody.github.io/oauth2_success.html"";
	</script>
  </body>
</html>";

            /// <summary>
            /// Create an instance of <see cref="NekoPlayerCodeReceiver"/>.
            /// </summary>
            public NekoPlayerCodeReceiver() : this(DefaultClosePageResponse, CallbackUriChooserStrategy.Default) { }

            /// <summary>
            /// Create an instance of <see cref="NekoPlayerCodeReceiver"/>.
            /// </summary>
            /// <param name="closePageResponse">Custom close page response for this instance</param>
            public NekoPlayerCodeReceiver(string closePageResponse) :
            ...
            public NekoPlayerCodeReceiver(string closePageResponse, CallbackUriChooserStrategy strategy)
            {
                ...
                CancellationToken taskCancellationToken)
            {
                ...
                Logger.Log($"Open a browser with \"{authorizationUrl}\" URL");
                ...
                if (!browserOpenedOk)
                {
                    Logger.Log($"Failed to launch browser with \"{authorizationUrl}\" for authorization; platform not supported.", level: LogLevel.Error);
                    throw new NotSupportedException(
